...
# arduino-cli compile --fqbn arduino:avr:mega ~/Dev/GitHub/PETEr/arduino/SparkFun_AS7265x_Arduino_Library/examples/Example1_BasicReadings/spectroJson.ino
# arduino-cli upload -p /dev/ttyACM0 --fqbn arduino:avr:mega ~/Dev/GitHub/PETEr/arduino/SparkFun_AS7265x_Arduino_Library/examples/Example1_BasicReadings/spectroJson.ino
# sudo chmod a+rw /dev/ttyACM0
# sudo usermod -a -G dialout $USER

# all-in-one: arduino-cli compile --fqbn arduino:avr:mega ~/Dev/GitHub/PETEr/arduino/SparkFun_AS7265x_Arduino_Library/examples/Example1_BasicReadings/spectroJson.ino && arduino-cli upload -p /dev/ttyACM0 --fqbn arduino:avr:mega ~/Dev/GitHub/PETEr/arduino/SparkFun_AS7265x_Arduino_Library/examples/Example1_BasicReadings/spectroJson.ino
        ...
        while self.is_running:
            ...
            if data:
                try:
                    ...
                    if isinstance(json_data, dict) and len(json_data) == 18:
                        self.data_signal.emit(decoded_data)
...
class MainWindow(QMainWindow):
    ...
    def set_file_location(self):
        ...
        defaultSaveLocation = "/home/parker/Dev/GitHub/PETEr/subsystems/spectrophotometer/spectralDataClassifier/recordings/with_glass/"
        ...
        fileName, _ = QFileDialog.getSaveFileName(
            self,
            "Set File Location",
            defaultSaveLocation,  # Use the default save location here
